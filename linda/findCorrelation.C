...
double findCorrelation(double *par, double *eventNumberIndex, double *thetaWaveIndex, double *phiWaveIndex, int *antIndex1, int *antIndex2, double *maxCorrTimeIndex, bool *adjacent);
...
double findCorrelation(double *par, double *eventNumberIndex, double *thetaWaveIndex, double *phiWaveIndex, int *antIndex1, int *antIndex2, double *maxCorrTimeIndex, bool *adjacent){
  ...
  for(unsigned int i = 0; i<MAX_ANTENNAS;++i){
    deltaZ[i]=par[i];
    deltaCableDelays[i] = par[i+MAX_ANTENNAS];
  }
