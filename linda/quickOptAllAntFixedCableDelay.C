...
double quickOptAllAntFixedCableDelay(double *par, double *eventNumberIndex, double *thetaWaveIndex, double *phiWaveIndex, int *antIndex1, int *antIndex2, double *maxCorrTimeIndex, bool *adjacent);
...
//     }
  ...
  Double_t sumMeanAdj = getMean(AdjacentAntDeltaT, countAdjacent);
  Double_t sumMeanVert = getMean(VerticalAntDeltaT, countVertical);
  Double_t sumRMSAdj = getRMS(AdjacentAntDeltaT, countAdjacent);
  Double_t sumRMSVert = getRMS(VerticalAntDeltaT, countVertical);
