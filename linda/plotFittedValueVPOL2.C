...
void plotFittedValueVPOL2(){
  ...
  string filename[numfile]={"newLindaNumbers_4steps_VPOL_10kVSeavey_2015_11_19_time_11_49_04.txt", "newLindaNumbers_4steps_HPOL_2015_11_19_time_15_06_17.txt", "newLindaNumbers_4steps_LDBHPOL_10kVSeavey_2015_11_19_time_15_30_45.txt"};
  ...
  c1->cd();
  leg->Draw();
  c1->Print("FittedValues_VPOL_R_4steps_ALL.png");
  c1->Print("FittedValues_VPOL_R_4steps_ALL.pdf");

  c2->cd();
  leg->Draw();
  c2->Print("FittedValues_VPOL_Z_4steps_ALL.png");
  c2->Print("FittedValues_VPOL_Z_4steps_ALL.pdf");

  c3->cd();
  leg->Draw();
  c3->Print("FittedValues_VPOL_PHI_4steps_ALL.png");
  c3->Print("FittedValues_VPOL_PHI_4steps_ALL.pdf");

  c4->cd();
  leg->Draw();
  c4->Print("FittedValues_VPOL_CableDelay_4steps_ALL.png");
  c4->Print("FittedValues_VPOL_CableDelay_4steps_ALL.pdf");
